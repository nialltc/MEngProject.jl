...
function fun_dv!(dv::AbstractArray, v::AbstractArray, u::AbstractArray, x_lgn::AbstractArray, p::NamedTuple)
    ...
    @. dv = p.δ_v * ( - v +
            ((1.0f0 - v) * max(u,0) * (1.0f0 + p.C_1 * x_lgn)) -
            ((1.0f0 + v) * p.C_2 * dv))
    return nothing
end
...
#     L2/3 excit
function fun_dz!(dz::AbstractArray, z::AbstractArray,  y::AbstractArray, H_z::AbstractArray, s::AbstractArray, p::NamedTuple)
...
#     V2 L6
function fun_dx_v2!(dx::AbstractArray, x_v2::AbstractArray, z_v2::AbstractArray, z::AbstractArray, p::NamedTuple)
    @. dx = p.δ_c *   (  -x_v2 +
                    ((1.0f0 - x_v2) *
